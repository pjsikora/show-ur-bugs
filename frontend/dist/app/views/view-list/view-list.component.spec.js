...
testing_1.describe('Component: ViewList', function () {
    var builder;
...
var ViewListComponentTestController = (function () {
    function ViewListComponentTestController() {
    }
    ViewListComponentTestController = __decorate([
        core_1.Component({
            selector: 'test',
    ...
    ], ViewListComponentTestController);
    return ViewListComponentTestController;
}());
