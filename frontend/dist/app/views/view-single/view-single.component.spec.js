...
var view_single_component_1 = require('./view-single.component');
...
var ViewSingleComponentTestController = (function () {
    ...
    ViewSingleComponentTestController = __decorate([
        core_1.Component({
            selector: 'test',
            template: "\n    <app-view-single></app-view-single>\n  ",
            directives: [view_single_component_1.ViewSingleComponent]
        }), 
        __metadata('design:paramtypes', [])
    ], ViewSingleComponentTestController);
    return ViewSingleComponentTestController;
}());
//# sourceMappingURL=view-single.component.spec.js.map